...
export default function Signin() {
  ...
  useEffect(() => {
    ...
    if (role === "women") {
      router.push("/womendashboard/overview");
    } else if (role === "police") {
      router.push("/policedashboard/overview");
    } else {
      setLoading(false);
    }
  });
    ...
    try {
      ...
      setTimeout(() => {
        if (data.role === "women") {
          ...
          router.push("/womendashboard/overview");
        } else if (data.role === "ASP" || data.role === "Sub Inspector") {
            ...
            <div className="2xl:w-3/4 w-full">
              ...
              <div>
                <h1 className="text-sm  text-center mt-4">
                  Forgot Password?{" "}
                  <Link href={"/signup"} className="font-bold text-[#FF2EBC]">
                    Signup
                  </Link>
                </h1>
              </div>
